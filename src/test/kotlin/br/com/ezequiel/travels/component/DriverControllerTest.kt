...
class DriverControllerTest {
    ...
    fun whenFullUpdateDriverThenReturnStatusNoContent() {
        val driverId = driverRepository.save(DriverEntity(null, "Ezequiel", LocalDate.ofEpochDay(0))).id
    ...
    fun whenListDriversThenReturnStatusOkAndResponseBody() {
        driverRepository.save(DriverEntity(null, "Ezequiel", LocalDate.ofEpochDay(0)))
        RestAssured
            .given()
            .contentType(ContentType.JSON)
            .get("/drivers")
