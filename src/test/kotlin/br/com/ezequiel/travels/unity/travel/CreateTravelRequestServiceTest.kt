...
class CreateTravelRequestServiceTest {
    ...
    private val subject = CreateTravelRequestService(travelRepository, passengerRepository)
    ...
    fun whenCreateTravelRequestThenReturnCreatedTravel() {
        // given
        val newTravel = CreateTravelRequestModel(
