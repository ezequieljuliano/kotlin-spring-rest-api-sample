...
import br.com.ezequiel.travels.service.passenger.ListAllPassengersService
...
class ListAllPassengersServiceTest {
    ...
    private fun assertEquals(mockedPassenger: PassengerEntity, resultPassenger: Passenger) {
